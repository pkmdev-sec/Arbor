...
export async function executeParallel(subtasks, depth, contextFile, workDir, scoutSummary, busSocketPath = null) {
...
export async function executePipeline(task, depth, contextFile, workDir, busSocketPath = null) {
  const preset = DEPTH[depth];
  const mainCwd = process.cwd();
