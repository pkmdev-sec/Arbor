...
export async function executeParallel(subtasks, depth, contextFile, workDir, scoutSummary) {
  ...
  // Store conflict report on the results array for contract building
...
export function buildContract(task, mode, workerResults, verifyResult, totalMs, workDir, conflictReport = null) {
