...
function Monitor() {
  ...
  if (viewMode === 'agents' && selectedRun) {
    ...
    const mainPanel = showChat
      ? e(ChatPanel, { workDir: selectedRun.dir, height: Math.max(10, rows - 10) })
      : e(AgentDetail, {
          agent: selectedAgent,
          barWidth: layout.barWidth,
          logLines: layout.logLines,
    ...
    return e(Box, { flexDirection: 'column', width: cols },
      ...
      e(Box, { paddingX: 1 },
        ...
        showChat ? e(Text, { color: 'cyan', bold: true }, ' [CHAT]') : null,
      ),
      // Side-by-side
      ...
      // Footer
      e(Box, { paddingX: 1 },
        e(Text, { dimColor: true }, '↑↓/jk: navigate  Esc/h: back  i:chat  Tab: switch  ?:help  q:quit'),
      ),
    );
  }
  ...
  return e(Box, { flexDirection: 'column', width: cols },
    ...
    e(Box, { marginTop: 1, paddingX: 1 },
      e(Text, { dimColor: true }, '↑↓/jk: select run  Enter: drill in  i:chat  r: refresh  ?:help  q:quit'),
    ),
  );
}
