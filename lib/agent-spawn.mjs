...
export function spawnAgent({ task, role, model, turns, budget, resultFile, contextFile, systemPrompt, bdTask, agentId, cwd, quiet = false, ipcSocket = null, effort = null, fallbackModel = null, scope = null, timeout = null }) {
