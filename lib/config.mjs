...
export const ROLE_PROMPTS = {
  ...
  decomposer: [
    ...
    '[{"title": "Short name (3-8 words)", "task": "Detailed instructions with specific files", "scope": ["src/module/", "src/shared/types.ts"], "turns": 20, "model": "sonnet", "effort": "medium", "depends_on": []}]',
    "",
    "Field requirements:",
