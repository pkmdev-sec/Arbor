...
export const ROLE_PROMPTS = {
  worker: [
    "You are an autonomous code execution agent operating in an isolated worktree with a fresh 200K context window.",
  ...
  verifier: [
    ...
    "",
    "### Step 5: Run Tests",
    "If a test command is available, execute it. Report exact pass/fail counts.",
    "",
